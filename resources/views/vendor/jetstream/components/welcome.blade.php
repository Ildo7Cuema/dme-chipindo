<div class="row justify-content-center my-5">
    ...
    <div class="col-md-12">
        <div class="card shadow gb-light mb-4">
            ...
            <div class="card-body mb-4">
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center mt-4">
                        <lable class="text-secondary font-weight-bold"><strong>Secretaria Geral</strong></lable>
                        <a href="{{ route('secGeral') }}">
                            <h1>
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center mt-4">
                        <lable class="text-secondary font-weight-bold"><strong>Plan. Estat. & Rec. Humanos</strong></lable>
                        <a href="#" class="">
                            <h1>
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center mt-4">
                        <lable class="text-secondary font-weight-bold"><strong>Secção de Ensino</strong></lable>
                        <a href="#" class="">
                            <h1>
    ...
    {{-- Abaixo encontra-se as divs padrão do laravel --}}
